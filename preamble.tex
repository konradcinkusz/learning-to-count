...
\newcommand{\numeroDeHoy}[4]{%
  \begin{cajaNumero}
  \begin{tabularx}{\linewidth}{@{}>{\centering\arraybackslash}m{28mm}@{\hspace{3mm}}>{\centering\arraybackslash}m{42mm}@{\hspace{3mm}}>{\centering\arraybackslash}X@{}}
  {\fontsize{92}{92}\selectfont\bfseries\color{colorLectura}#1} &
  {\fontsize{30}{34}\selectfont\bfseries #2}\par\vspace{3mm}\marcoDiez{#1} &
  #3 \\
  \end{tabularx}
  \par\vspace{2mm}
  {\large #4\par}
