...
\subsection*{Desde el verano}
\begin{itemize}[leftmargin=5mm, itemsep=1pt, topsep=0pt]
\item \textbf{\lblTabla}: cada fila es una decena; se dicen los números
  fila a fila, y se escriben los que faltan.
\item \textbf{\lblDinero}: contar primero los billetes y después las
  monedas, y escribir cuántos euros hay.
\item \textbf{\lblHora}: la aguja corta dice la hora; la larga, arriba
  del todo, es «en punto», y abajo del todo, «y media».
\item \textbf{\lblMide}: contar los cubitos que hay debajo del lápiz,
  desde la goma hasta la punta; con dos lápices, rodear el más largo.
\end{itemize}
\end{multicols}}
\newpage
