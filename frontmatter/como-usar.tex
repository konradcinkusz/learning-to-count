...
% En dos columnas: cada trimestre trae actividades nuevas, y la lista
% tiene que seguir cabiendo en esta página (tools/check_pages.py
% comprueba que el día 1 está en la página 4).
{\small
\begin{multicols}{2}
\raggedright
